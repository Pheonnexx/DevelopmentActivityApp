...
users = User.create!([{ id: '1234', first_name: 'Super', surname: 'User', email: 'superuser1@gmail.com', password: '!superuser1', password_confirmation: '!superuser1', admin: 'true', line_manager: 'true', role_id: '1234'}])
